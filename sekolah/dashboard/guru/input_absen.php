...
<body>
  ...
  <header id="header" class="bg-blue-600 text-white py-4 transition-all duration-300">
    ...
    <div class="container mt-4">
        <h1 class="text-center mb-4">Absensi Sekolah</h1>
        ...
        <table id="siswaTable" class="table table-bordered hidden">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Matematika</td>
                    <td>
                        <select class="form-select" name="kehadiran1">
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-select" name="kehadiran2">
                            <option value="Hadir">Hadir</option>
                            <option value="Sakit">Sakit</option>
                            <option value="Izin">Izin</option>
                            <option value="Alpa">Alpa</option>
        ...
        <div class="text-center">
            <button class="btn btn-primary" onclick="submitAbsensi()">Simpan Absensi</button>
        </div>
    </div>
